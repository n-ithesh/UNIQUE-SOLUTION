...
<!-- Header navigation -->
    <header>
        ...
        <div class="icons">
            ...
            <a href="./controller/logout.php" class="fa-solid fa-user"></a>
        </div>
    ...
    <section class="about" id="about">
        ...
        <div class="row">
            ...
            <div class="content">
                ...
                <a href="#service-page" class="btn">know more</a>
            </div>
    ...
    <section>
        <div class="service-container" id="service-page">
            <div class="service">
                ...
                <img src="Assets/Images/cctv.jpg" alt="Service 1">
            ...
            <div class="service">
                <h3>Solar Systems</h3>
                <img src="Assets\Images\solar.jpg" alt="Service 2">
                <div class="service-info">
            ...
            <div class="service">
                ...
                <img src="Assets/Images/biometrics.jpg" alt="Service 4">
                <div class="service-info">
                    <p>Keep your hardware infrastructure up to date with our hardware upgrade services. Whether you need to replace outdated equipment or enhance performance with the latest technology, we offer cost-effective upgrade solutions.</p>
                    <a href="book.php"><button class="book-button">Book Now</button></a>
                </div>
            ...
            <div class="service">
                ...
                <img src="Assets/Images/intercom.jpg" alt="Service 4">
                <div class="service-info">
                    <p>Keep your hardware infrastructure up to date with our hardware upgrade services. Whether you need to replace outdated equipment or enhance performance with the latest technology, we offer cost-effective upgrade solutions.</p>
                    <a href="book.php"><button class="book-button">Book Now</button></a>
                </div>
...
<section class="products" id="products">
  ...
  <section class="icons-container">
        ...
        <div class="icons">
            <img src="Assets/Images/client/sharada.png" alt="">
            <div class="info">
    ...
    <section class="partner-container">
            <div class="partner">
                <img src="Assets\Images\partner\mcafree.png" alt="Partner 1">
                <div class="partner-info">
                    <h3>Company A</h3>
                    <p>Leading provider of networking solutions.</p>
                </div>
            </div>
            <div class="partner">
                <img src="Assets\Images\partner\dell.jpg" alt="Partner 2">
                <div class="partner-info">
                    <h3>Company B</h3>
                    <p>Specializing in security systems and services.</p>
                </div>
            </div>
            <div class="partner">
                <img src="Assets\Images\partner\hp.pngg" alt="Partner 3">
                <div class="partner-info">
                    <h3>Company C</h3>
                    <p>Provider of cutting-edge data storage solutions.</p>
                </div>
            </div>
            <div class="partner">
                ...
                <div class="partner-info">
                    <h3>Company D</h3>
                    <p>Expert in hardware upgrades and maintenance.</p>
                </div>
            </div>
    </section>
